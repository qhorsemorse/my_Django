# Generated by Django 5.1.1 on 2024-09-23 16:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='some_app_blog_maybe.article', verbose_name='Стаття')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='news', to='some_app_blog_maybe.category', verbose_name='Категорія'),
        ),
    ]
